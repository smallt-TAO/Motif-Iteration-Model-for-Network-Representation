...
# 			ws = matrix_random(ws)
# 			ws = matrix_change(ws)
# 			imsave("G:\\code_Python\\see_network\\data_ws\\small_word_{0}_{1}_{2}.png".format(str(k), str(p), str(ii)), ws)
#
...
# 			ba = matrix_change(ba)
# 			imsave(
# 				"G:\\code_Python\\see_network\\data_ba\\scale_free_{0}_{1}_{2}.png".format(str(num), str(m), str(ii)), ba)
#
